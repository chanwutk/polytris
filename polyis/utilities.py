...
def load_classification_results(cache_dir: str, dataset: str, video_file: str,
                                tile_size: int, classifier: str, filter_type: str, verbose: bool = False) -> list:
    """
    ...
    Args:
        ...
        filter_type (str): Filter type used during classification
        verbose (bool): Whether to print verbose output
    ...
    score_dir = os.path.join(cache_dir, dataset, video_file, 'relevancy', f'{classifier}_{tile_size}_{filter_type}', 'score')
