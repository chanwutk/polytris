...
def load_detection_results(cache_dir: str, dataset: str, video_file: str, tracking: bool = False, verbose: bool = False, filename: str | None = None) -> list[dict]:
    """
...
def create_visualization_frame(frame: np.ndarray, tracks: list[list[float]], frame_idx: int,
    ...
    # Draw frame index in the upper right corner
    ...
    # Position text in upper right corner with padding
    padding = 10
    text_x = vis_frame.shape[1] - text_width - padding
