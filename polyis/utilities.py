...
def load_detection_results(cache_dir: str, dataset: str, video_file: str, tracking: bool = False,
    ...
    detection_path = os.path.join(cache_dir, dataset, 'execution', video_file, '002_naive' if not groundtruth else '003_groundtruth', filename)
...
def load_classification_results(cache_dir: str, dataset: str, video_file: str,
    ...
    score_dir = os.path.join(cache_dir, dataset, 'execution', video_file, '020_relevancy', f'{classifier}_{tilesize}_{sample_rate}', 'score')
...
def load_pruned_classification_results(cache_dir: str, dataset: str, video_file: str,
    ...
    results_file = os.path.join(score_dir, 'score.jsonl')
