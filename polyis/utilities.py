...
def load_detection_results(cache_dir: str, dataset: str, video_file: str, tracking: bool = False, verbose: bool = False, filename: str | None = None, groundtruth: bool = False) -> list[dict]:
    """
...
def load_classification_results(cache_dir: str, dataset: str, video_file: str,
                                tilesize: int, classifier: str, verbose: bool = False) -> list:
    """
