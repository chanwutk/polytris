...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "/usr/local/lib/python3.13/site-packages/numpy/_core/include/numpy/arrayobject.h",
            "/usr/local/lib/python3.13/site-packages/numpy/_core/include/numpy/arrayscalars.h",
            "/usr/local/lib/python3.13/site-packages/numpy/_core/include/numpy/ndarrayobject.h",
            "/usr/local/lib/python3.13/site-packages/numpy/_core/include/numpy/ndarraytypes.h",
            "/usr/local/lib/python3.13/site-packages/numpy/_core/include/numpy/ufuncobject.h",
            "polyis/pack/c/pack_ffd.h",
            "polyis/pack/c/utilities.h"
        ],
        "extra_compile_args": [
            "-O3",
            "-ffast-math",
    ...
    "module_name": "polyis.pack.pack_ffd"
}
END: Cython Metadata */
...
#define __PYX_HAVE__polyis__pack__pack_ffd
#define __PYX_HAVE_API__polyis__pack__pack_ffd
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition;
...
/* Module declarations from "polyis.pack.pack_ffd" */
...
static PyObject *__pyx_f_6polyis_4pack_8pack_ffd_convert_collage_array_to_python(CollageArray *); /*proto*/
static PyObject *__pyx_f_6polyis_4pack_8pack_ffd___pyx_unpickle_PyPolyominoPosition__set_state(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *, PyObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "polyis.pack.pack_ffd"
extern int __pyx_module_is_main_polyis__pack__pack_ffd;
int __pyx_module_is_main_polyis__pack__pack_ffd = 0;

/* Implementation of "polyis.pack.pack_ffd" */
...
static const char __pyx_k_ox_2[] = ", ox=";
static const char __pyx_k_pack[] = "pack";
static const char __pyx_k_px_2[] = ", px=";
...
static const char __pyx_k_collages[] = "collages";
static const char __pyx_k_getstate[] = "__getstate__";
static const char __pyx_k_itemsize[] = "itemsize";
static const char __pyx_k_pack_all[] = "pack_all";
...
static const char __pyx_k_arrays_ptr[] = "arrays_ptr";
...
static const char __pyx_k_polyominoes_stacks[] = "polyominoes_stacks";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_PyPolyominoPosition[] = "PyPolyominoPosition";
static const char __pyx_k_PolyominoPosition_oy[] = "PolyominoPosition(oy=";
static const char __pyx_k_polyis_pack_pack_ffd[] = "polyis.pack.pack_ffd";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_Invalid_shape_in_axis[] = "Invalid shape in axis ";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_Cannot_index_with_type[] = "Cannot index with type '";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_pack_all__returned_NULL[] = "pack_all_ returned NULL";
static const char __pyx_k_polyis_pack_pack_ffd_pyx[] = "polyis/pack/pack_ffd.pyx";
static const char __pyx_k_Dimension_d_is_not_direct[] = "Dimension %d is not direct";
static const char __pyx_k_Index_out_of_bounds_axis_d[] = "Index out of bounds (axis %d)";
static const char __pyx_k_Step_may_not_be_zero_axis_d[] = "Step may not be zero (axis %d)";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_list_list_PyPolyominoPosition[] = "list[list[PyPolyominoPosition]]";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_pyx_unpickle_PyPolyominoPositi[] = "__pyx_unpickle_PyPolyominoPosition";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_89_Qa_Q_q_6_Rq_Q_k_U_1_5_OqPQ_Y[] = "\200\001\360\006\00089\360&\000\005\033\230#\230Q\230a\360\014\000\005\010\200{\220#\220Q\330\010\017\210q\360\006\000\005\022\320\021#\2406\250\021\250(\260+\270R\270q\330\004\007\200{\220#\220Q\330\010\016\210k\230\021\230!\360\006\000\005\t\210\005\210U\220!\2201\330\010\022\220!\2205\320\030)\320)=\320=O\310q\320PQ\360\006\000\005\016\210Y\220a\220|\240<\250s\260!\340\004\007\200w\210c\220\021\330\010\016\210k\230\021\230!\360\006\000\005\020\320\017.\250a\250q\360\006\000\005\031\230\001\230\021\330\004\010\210\001\210\027\220\001\340\004\013\2101";
static const char __pyx_k_T_U_e4uD_T_DPQ_G1F_a_vWA_q_t7_q[] = "\200\001\360\010\000\005\016\210T\220\030\230\024\230U\240$\240e\2504\250u\260D\270\005\270T\300\033\310D\320PQ\330\004\014\210G\2201\220F\230,\240a\330\004\007\200v\210W\220A\330\010\022\220!\330\010\027\220q\340\010\027\220t\2307\240'\250\021\330\004\007\200q\330\010\017\320\0174\260D\270\001\270\027\300\013\3107\320RS\340\010\017\320\0174\260D\270\001\270\027\300\013\3101";
...
static const char __pyx_k_Failed_to_allocate_memory_for_po[] = "Failed to allocate memory for polyominoes arrays";
...
static const char __pyx_k_PyPolyominoPosition___reduce_cyt[] = "PyPolyominoPosition.__reduce_cython__";
static const char __pyx_k_PyPolyominoPosition___setstate_c[] = "PyPolyominoPosition.__setstate_cython__";
...
static const char __pyx_k_Incompatible_checksums_0x_x_vs_0_2[] = "Incompatible checksums (0x%x vs (0x4e12040, 0x41fcdc0, 0xe0a31f9) = (frame, ox, oy, px, py, rotation, shape))";
/* #### Code section: decls ### */
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition___init__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, int __pyx_v_oy, int __pyx_v_ox, int __pyx_v_py, int __pyx_v_px, int __pyx_v_rotation, int __pyx_v_frame, PyObject *__pyx_v_shape); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2__repr__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_4__del__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_4__reduce_cython__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_6__setstate_cython__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_pack_all(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_polyominoes_stacks, int __pyx_v_h, int __pyx_v_w); /* proto */
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_2__pyx_unpickle_PyPolyominoPosition(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_tp_new_6polyis_4pack_8pack_ffd_PyPolyominoPosition(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
typedef struct {
  ...
  PyObject *__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition;
  PyObject *__pyx_type___pyx_array;
  PyObject *__pyx_type___pyx_MemviewEnum;
  PyObject *__pyx_type___pyx_memoryview;
  PyObject *__pyx_type___pyx_memoryviewslice;
  PyTypeObject *__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition;
...
#define __pyx_kp_u_Failed_to_allocate_memory_for_po __pyx_string_tab[13]
#define __pyx_n_u_ImportError __pyx_string_tab[14]
#define __pyx_kp_u_Incompatible_checksums_0x_x_vs_0 __pyx_string_tab[15]
#define __pyx_kp_u_Incompatible_checksums_0x_x_vs_0_2 __pyx_string_tab[16]
#define __pyx_n_u_IndexError __pyx_string_tab[17]
#define __pyx_kp_u_Index_out_of_bounds_axis_d __pyx_string_tab[18]
#define __pyx_kp_u_Indirect_dimensions_not_supporte __pyx_string_tab[19]
...
#define __pyx_kp_u_PolyominoPosition_oy __pyx_string_tab[28]
#define __pyx_n_u_PyPolyominoPosition __pyx_string_tab[29]
#define __pyx_n_u_PyPolyominoPosition___reduce_cyt __pyx_string_tab[30]
#define __pyx_n_u_PyPolyominoPosition___setstate_c __pyx_string_tab[31]
#define __pyx_n_u_Sequence __pyx_string_tab[32]
#define __pyx_kp_u_Step_may_not_be_zero_axis_d __pyx_string_tab[33]
#define __pyx_n_u_TypeError __pyx_string_tab[34]
#define __pyx_kp_u_Unable_to_convert_item_to_object __pyx_string_tab[35]
#define __pyx_n_u_ValueError __pyx_string_tab[36]
#define __pyx_n_u_View_MemoryView __pyx_string_tab[37]
...
#define __pyx_n_u_abc __pyx_string_tab[44]
#define __pyx_kp_u_add_note __pyx_string_tab[45]
#define __pyx_n_u_allocate_buffer __pyx_string_tab[46]
#define __pyx_kp_u_and __pyx_string_tab[47]
#define __pyx_n_u_arrays_ptr __pyx_string_tab[48]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[49]
#define __pyx_kp_u_at_0x __pyx_string_tab[50]
...
#define __pyx_n_u_collages __pyx_string_tab[56]
...
#define __pyx_kp_u_frame_2 __pyx_string_tab[74]
...
#define __pyx_n_u_h __pyx_string_tab[80]
...
#define __pyx_kp_u_list_list_PyPolyominoPosition __pyx_string_tab[90]
#define __pyx_n_u_main __pyx_string_tab[91]
#define __pyx_n_u_memview __pyx_string_tab[92]
...
#define __pyx_n_u_num_arrays __pyx_string_tab[101]
...
#define __pyx_kp_u_object __pyx_string_tab[106]
#define __pyx_n_u_ox __pyx_string_tab[107]
#define __pyx_kp_u_ox_2 __pyx_string_tab[108]
#define __pyx_n_u_oy __pyx_string_tab[109]
#define __pyx_n_u_pack __pyx_string_tab[110]
#define __pyx_n_u_pack_all __pyx_string_tab[111]
#define __pyx_kp_u_pack_all__returned_NULL __pyx_string_tab[112]
#define __pyx_n_u_pickle __pyx_string_tab[113]
#define __pyx_n_u_polyis_pack_pack_ffd __pyx_string_tab[114]
#define __pyx_kp_u_polyis_pack_pack_ffd_pyx __pyx_string_tab[115]
#define __pyx_n_u_polyominoes_stacks __pyx_string_tab[116]
#define __pyx_n_u_pop __pyx_string_tab[117]
#define __pyx_n_u_px __pyx_string_tab[118]
#define __pyx_kp_u_px_2 __pyx_string_tab[119]
#define __pyx_n_u_py __pyx_string_tab[120]
#define __pyx_kp_u_py_2 __pyx_string_tab[121]
#define __pyx_n_u_pyx_PickleError __pyx_string_tab[122]
...
#define __pyx_n_u_pyx_unpickle_PyPolyominoPositi __pyx_string_tab[128]
...
#define __pyx_n_u_rotation __pyx_string_tab[138]
#define __pyx_kp_u_rotation_2 __pyx_string_tab[139]
...
#define __pyx_kp_u_shape_2 __pyx_string_tab[145]
...
#define __pyx_kp_u_stringsource __pyx_string_tab[155]
#define __pyx_n_u_struct __pyx_string_tab[156]
#define __pyx_n_u_test __pyx_string_tab[157]
#define __pyx_n_u_uint8 __pyx_string_tab[158]
...
#define __pyx_n_u_use_setstate __pyx_string_tab[163]
#define __pyx_n_u_w __pyx_string_tab[164]
#define __pyx_n_u_x __pyx_string_tab[165]
#define __pyx_n_u_zeros __pyx_string_tab[166]
...
static CYTHON_SMALL_CODE int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
  Py_CLEAR(clear_module_state->__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
  ...
  Py_CLEAR(clear_module_state->__pyx_int_69193152);
  Py_CLEAR(clear_module_state->__pyx_int_81862720);
  ...
  Py_CLEAR(clear_module_state->__pyx_int_235549177);
...
static CYTHON_SMALL_CODE int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
  Py_VISIT(traverse_module_state->__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
  ...
  __Pyx_VISIT_CONST(traverse_module_state->__pyx_int_69193152);
  __Pyx_VISIT_CONST(traverse_module_state->__pyx_int_81862720);
  ...
  __Pyx_VISIT_CONST(traverse_module_state->__pyx_int_235549177);
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_oy;
  int __pyx_v_ox;
  int __pyx_v_py;
  int __pyx_v_px;
  ...
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_oy,&__pyx_mstate_global->__pyx_n_u_ox,&__pyx_mstate_global->__pyx_n_u_py,&__pyx_mstate_global->__pyx_n_u_px,&__pyx_mstate_global->__pyx_n_u_rotation,&__pyx_mstate_global->__pyx_n_u_frame,&__pyx_mstate_global->__pyx_n_u_shape,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_VARARGS(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      for (Py_ssize_t i = __pyx_nargs; i < 7; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, i); __PYX_ERR(0, 75, __pyx_L3_error) }
      }
    ...
    __pyx_v_oy = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_oy == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_ox = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_ox == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_py = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_py == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_px = __Pyx_PyLong_As_int(values[3]); if (unlikely((__pyx_v_px == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_rotation = __Pyx_PyLong_As_int(values[4]); if (unlikely((__pyx_v_rotation == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_frame = __Pyx_PyLong_As_int(values[5]); if (unlikely((__pyx_v_frame == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L3_error)
    __pyx_v_shape = values[6];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, __pyx_nargs); __PYX_ERR(0, 75, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition___init__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), __pyx_v_oy, __pyx_v_ox, __pyx_v_py, __pyx_v_px, __pyx_v_rotation, __pyx_v_frame, __pyx_v_shape);
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition___init__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, int __pyx_v_oy, int __pyx_v_ox, int __pyx_v_py, int __pyx_v_px, int __pyx_v_rotation, int __pyx_v_frame, PyObject *__pyx_v_shape) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__init__", 0);

  __pyx_v_self->oy = __pyx_v_oy;

  __pyx_v_self->ox = __pyx_v_ox;
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_3__repr__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_3__repr__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__repr__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2__repr__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2__repr__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  ...
  __pyx_t_1 = __Pyx_PyObject_FormatSimple(__pyx_v_self->shape, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_shape_2, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_shape_info = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __Pyx_PyUnicode_From_int(__pyx_v_self->oy, 0, ' ', 'd'); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyUnicode_From_int(__pyx_v_self->ox, 0, ' ', 'd'); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyUnicode_From_int(__pyx_v_self->py, 0, ' ', 'd'); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyUnicode_From_int(__pyx_v_self->px, 0, ' ', 'd'); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyUnicode_From_int(__pyx_v_self->rotation, 0, ' ', 'd'); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyUnicode_From_int(__pyx_v_self->frame, 0, ' ', 'd'); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7[0] = __pyx_mstate_global->__pyx_kp_u_PolyominoPosition_oy;
  __pyx_t_7[1] = __pyx_t_2;
  __pyx_t_7[2] = __pyx_mstate_global->__pyx_kp_u_ox_2;
  __pyx_t_7[3] = __pyx_t_1;
  __pyx_t_7[4] = __pyx_mstate_global->__pyx_kp_u_py_2;
  __pyx_t_7[5] = __pyx_t_3;
  __pyx_t_7[6] = __pyx_mstate_global->__pyx_kp_u_px_2;
  __pyx_t_7[7] = __pyx_t_4;
  __pyx_t_7[8] = __pyx_mstate_global->__pyx_kp_u_rotation_2;
  __pyx_t_7[9] = __pyx_t_5;
  __pyx_t_7[10] = __pyx_mstate_global->__pyx_kp_u_frame_2;
  __pyx_t_7[11] = __pyx_t_6;
  __pyx_t_7[12] = __pyx_mstate_global->__pyx_kp_u__6;
  __pyx_t_7[13] = __pyx_v_shape_info;
  __pyx_t_7[14] = __pyx_mstate_global->__pyx_kp_u__5;
  __pyx_t_8 = __Pyx_PyUnicode_Join(__pyx_t_7, 15, 21 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_2) + 5 * 3 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_1) + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_3) + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_4) + 11 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_5) + 8 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_6) + 2 + __Pyx_PyUnicode_GET_LENGTH(__pyx_v_shape_info) + 1, 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_v_shape_info));
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.__repr__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->oy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.oy.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __pyx_t_1 = __Pyx_PyLong_As_int(__pyx_v_value); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.oy.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->ox); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.ox.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.ox.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->py); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.py.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.py.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->px); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.px.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.px.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->rotation); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.rotation.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.rotation.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->frame); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.frame.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.frame.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_1__get__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape___get__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape___get__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__", 0);
  __Pyx_XDECREF(__pyx_r);
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_2__set__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_2__set__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_5__del__(PyObject *__pyx_v_self); /*proto*/
static int __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_5__del__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__del__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_4__del__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static int __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_4__del__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__ = {"__reduce_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  if (unlikely(__pyx_kwds_len < 0)) return NULL;
  if (unlikely(__pyx_kwds_len > 0)) {__Pyx_RejectKeywords("__reduce_cython__", __pyx_kwds); return NULL;}
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_4__reduce_cython__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self));
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_4__reduce_cython__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self) {
  PyObject *__pyx_v_state = 0;
  PyObject *__pyx_v__dict = 0;
  int __pyx_v_use_setstate;
  PyObject *__pyx_r = NULL;
  ...
  __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_self->frame); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_self->ox); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_v_self->oy); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyLong_From_int(__pyx_v_self->px); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyLong_From_int(__pyx_v_self->py); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyLong_From_int(__pyx_v_self->rotation); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_7, 6, __pyx_v_self->shape) != (0)) __PYX_ERR(1, 5, __pyx_L1_error);
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  ...
  /*else*/ {
    __pyx_t_8 = (__pyx_v_self->shape != Py_None);
  ...
  if (__pyx_v_use_setstate) {
    ...
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_pyx_unpickle_PyPolyominoPositi); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    ...
    __Pyx_INCREF(__pyx_mstate_global->__pyx_int_81862720);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_int_81862720);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_7, 1, __pyx_mstate_global->__pyx_int_81862720) != (0)) __PYX_ERR(1, 13, __pyx_L1_error);
    __Pyx_INCREF(Py_None);
    __Pyx_GIVEREF(Py_None);
  ...
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_pyx_unpickle_PyPolyominoPositi); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    __Pyx_INCREF(__pyx_mstate_global->__pyx_int_81862720);
    __Pyx_GIVEREF(__pyx_mstate_global->__pyx_int_81862720);
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_7, 1, __pyx_mstate_global->__pyx_int_81862720) != (0)) __PYX_ERR(1, 15, __pyx_L1_error);
    __Pyx_INCREF(__pyx_v_state);
    __Pyx_GIVEREF(__pyx_v_state);
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_7);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_state);
  __Pyx_XDECREF(__pyx_v__dict);
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__ = {"__setstate_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("polyis.pack.pack_ffd.PyPolyominoPosition.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_6__setstate_cython__(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v_self), __pyx_v___pyx_state);
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_6__setstate_cython__(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  if (!(likely(PyTuple_CheckExact(__pyx_v___pyx_state))||((__pyx_v___pyx_state) == Py_None) || __Pyx_RaiseUnexpectedTypeError("tuple", __pyx_v___pyx_state))) __PYX_ERR(1, 17, __pyx_L1_error)
  __pyx_t_1 = __pyx_f_6polyis_4pack_8pack_ffd___pyx_unpickle_PyPolyominoPosition__set_state(__pyx_v_self, ((PyObject*)__pyx_v___pyx_state)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_1pack_all(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_polyominoes_stacks = 0;
  int __pyx_v_h;
  int __pyx_v_w;
  #if !CYTHON_METH_FASTCALL
  CYTHON_UNUSED Py_ssize_t __pyx_nargs;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pack_all (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_polyominoes_stacks,&__pyx_mstate_global->__pyx_n_u_h,&__pyx_mstate_global->__pyx_n_u_w,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "pack_all", 0) < 0) __PYX_ERR(0, 89, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("pack_all", 1, 3, 3, i); __PYX_ERR(0, 89, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 3)) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_polyominoes_stacks = ((PyObject*)values[0]);
    __pyx_v_h = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_h == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 92, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_w == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 92, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pack_all", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 89, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("polyis.pack.pack_ffd.pack_all", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_polyominoes_stacks), (&PyList_Type), 1, "polyominoes_stacks", 1))) __PYX_ERR(0, 92, __pyx_L1_error)
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_pack_all(__pyx_self, __pyx_v_polyominoes_stacks, __pyx_v_h, __pyx_v_w);
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_pack_all(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_polyominoes_stacks, int __pyx_v_h, int __pyx_v_w) {
  int __pyx_v_num_arrays;
  PolyominoArray **__pyx_v_arrays_ptr;
  CollageArray *__pyx_v_result;
  PyObject *__pyx_v_collages = 0;
  int __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("pack_all", 0);

  if (unlikely(__pyx_v_polyominoes_stacks == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 111, __pyx_L1_error)
  }
  __pyx_t_1 = __Pyx_PyList_GET_SIZE(__pyx_v_polyominoes_stacks); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 111, __pyx_L1_error)
  __pyx_v_num_arrays = __pyx_t_1;

  __pyx_t_2 = (__pyx_v_num_arrays == 0);
  if (__pyx_t_2) {
  ...
  __pyx_v_arrays_ptr = ((PolyominoArray **)malloc((((size_t)__pyx_v_num_arrays) * (sizeof(PolyominoArray *)))));

  __pyx_t_2 = (__pyx_v_arrays_ptr == NULL);
  if (unlikely(__pyx_t_2)) {
    ...
    __pyx_t_6 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_4, __pyx_mstate_global->__pyx_kp_u_Failed_to_allocate_memory_for_po};
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    __pyx_t_10 = __Pyx_PyLong_As_unsigned_PY_LONG_LONG(__Pyx_PyList_GET_ITEM(__pyx_v_polyominoes_stacks, __pyx_v_i)); if (unlikely((__pyx_t_10 == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L1_error)
    (__pyx_v_arrays_ptr[__pyx_v_i]) = ((PolyominoArray *)((unsigned PY_LONG_LONG)__pyx_t_10));
  }

  __pyx_v_result = pack_all_(__pyx_v_arrays_ptr, __pyx_v_num_arrays, __pyx_v_h, __pyx_v_w);
  ...
  if (unlikely(__pyx_t_2)) {
    ...
    __pyx_t_6 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_5, __pyx_mstate_global->__pyx_kp_u_pack_all__returned_NULL};
  ...
  __pyx_t_3 = __pyx_f_6polyis_4pack_8pack_ffd_convert_collage_array_to_python(__pyx_v_result); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 136, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_collages = ((PyObject*)__pyx_t_3);
  __pyx_t_3 = 0;

  CollageArray_cleanup(__pyx_v_result);

  free(((void *)__pyx_v_result));

  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_collages);
  __pyx_r = __pyx_v_collages;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_collages);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_f_6polyis_4pack_8pack_ffd_convert_collage_array_to_python(CollageArray *__pyx_v_collage_array) {
  PyObject *__pyx_v_result = 0;
  PyObject *__pyx_v_collage_positions = 0;
  PolyominoPositionArray *__pyx_v_position_array;
  PolyominoPosition *__pyx_v_pos;
  CoordinateArray *__pyx_v_coords;
  ...
  struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v_poly_pos = NULL;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("convert_collage_array_to_python", 0);
  ...
  __pyx_t_2 = __pyx_v_collage_array->size;
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    __pyx_v_position_array = (&(__pyx_v_collage_array->data[__pyx_v_i]));

    __pyx_t_1 = PyList_New(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 170, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_collage_positions, ((PyObject*)__pyx_t_1));
    __pyx_t_1 = 0;

    __pyx_t_5 = __pyx_v_position_array->size;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      __pyx_v_pos = (&(__pyx_v_position_array->data[__pyx_v_j]));

      __pyx_v_coords = (&__pyx_v_pos->shape);

      __pyx_t_8 = (__pyx_v_coords->size == 0);
      if (__pyx_t_8) {
      ...
      __pyx_t_9 = (__pyx_v_coords->data[0]).y;
      __pyx_v_min_y = __pyx_t_9;

      __pyx_t_9 = (__pyx_v_coords->data[0]).y;
      __pyx_v_max_y = __pyx_t_9;

      __pyx_t_9 = (__pyx_v_coords->data[0]).x;
      __pyx_v_min_x = __pyx_t_9;

      __pyx_t_9 = (__pyx_v_coords->data[0]).x;
      __pyx_v_max_x = __pyx_t_9;

      __pyx_t_9 = __pyx_v_coords->size;
      __pyx_t_10 = __pyx_t_9;
      for (__pyx_t_11 = 1; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        __pyx_v_k = __pyx_t_11;

        __pyx_t_8 = ((__pyx_v_coords->data[__pyx_v_k]).y < __pyx_v_min_y);
        if (__pyx_t_8) {

          __pyx_t_12 = (__pyx_v_coords->data[__pyx_v_k]).y;
          __pyx_v_min_y = __pyx_t_12;

        }

        __pyx_t_8 = ((__pyx_v_coords->data[__pyx_v_k]).y > __pyx_v_max_y);
        if (__pyx_t_8) {
        ...
        __pyx_t_8 = ((__pyx_v_coords->data[__pyx_v_k]).x < __pyx_v_min_x);
        if (__pyx_t_8) {

          __pyx_t_12 = (__pyx_v_coords->data[__pyx_v_k]).x;
          __pyx_v_min_x = __pyx_t_12;

        }

        __pyx_t_8 = ((__pyx_v_coords->data[__pyx_v_k]).x > __pyx_v_max_x);
        if (__pyx_t_8) {

          __pyx_t_12 = (__pyx_v_coords->data[__pyx_v_k]).x;
          __pyx_v_max_x = __pyx_t_12;

        }
      }

      __pyx_v_mask_h = ((__pyx_v_max_y - __pyx_v_min_y) + 1);

      __pyx_v_mask_w = ((__pyx_v_max_x - __pyx_v_min_x) + 1);

      __pyx_t_13 = NULL;
      __Pyx_GetModuleGlobalName(__pyx_t_14, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_t_14, __pyx_mstate_global->__pyx_n_u_zeros); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_14 = __Pyx_PyLong_From_int(__pyx_v_mask_h); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_16 = __Pyx_PyLong_From_int(__pyx_v_mask_w); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_17 = PyTuple_New(2); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_17);
      __Pyx_GIVEREF(__pyx_t_14);
      if (__Pyx_PyTuple_SET_ITEM(__pyx_t_17, 0, __pyx_t_14) != (0)) __PYX_ERR(0, 199, __pyx_L1_error);
      __Pyx_GIVEREF(__pyx_t_16);
      if (__Pyx_PyTuple_SET_ITEM(__pyx_t_17, 1, __pyx_t_16) != (0)) __PYX_ERR(0, 199, __pyx_L1_error);
      __pyx_t_14 = 0;
      __pyx_t_16 = 0;
      __Pyx_GetModuleGlobalName(__pyx_t_16, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_mstate_global->__pyx_n_u_uint8); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 199, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      ...
      #endif
      {
        ...
        __pyx_t_16 = __Pyx_MakeVectorcallBuilderKwds(1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 199, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_dtype, __pyx_t_14, __pyx_t_16, __pyx_callargs+2, 0) < 0) __PYX_ERR(0, 199, __pyx_L1_error)
      ...
      __pyx_t_19 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_uint8_t(__pyx_v_mask, PyBUF_WRITABLE); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 200, __pyx_L1_error)
      __PYX_XCLEAR_MEMVIEW(&__pyx_v_mask_view, 1);
      __pyx_v_mask_view = __pyx_t_19;
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        __pyx_t_20 = ((__pyx_v_coords->data[__pyx_v_k]).y - __pyx_v_min_y);
        __pyx_t_21 = ((__pyx_v_coords->data[__pyx_v_k]).x - __pyx_v_min_x);
        *((__pyx_t_5numpy_uint8_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mask_view.data + __pyx_t_20 * __pyx_v_mask_view.strides[0]) ) + __pyx_t_21 * __pyx_v_mask_view.strides[1]) )) = 1;
      }

      __pyx_t_15 = NULL;
      __Pyx_INCREF((PyObject *)__pyx_mstate_global->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
      __pyx_t_16 = ((PyObject *)__pyx_mstate_global->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition); 

      __pyx_t_14 = __Pyx_PyLong_From_int(__pyx_v_pos->oy); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 208, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);

      __pyx_t_17 = __Pyx_PyLong_From_int(__pyx_v_pos->ox); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 209, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_17);

      __pyx_t_13 = __Pyx_PyLong_From_int(__pyx_v_pos->py); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 210, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);

      __pyx_t_22 = __Pyx_PyLong_From_int(__pyx_v_pos->px); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 211, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_22);

      __pyx_t_23 = __Pyx_PyLong_From_int(__pyx_v_pos->rotation); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 212, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_23);

      __pyx_t_24 = __Pyx_PyLong_From_int(__pyx_v_pos->frame); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 213, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_24);

      __pyx_t_18 = 1;
      {
        PyObject *__pyx_callargs[2 + ((CYTHON_VECTORCALL) ? 7 : 0)] = {__pyx_t_15, NULL};
        __pyx_t_25 = __Pyx_MakeVectorcallBuilderKwds(7); if (unlikely(!__pyx_t_25)) __PYX_ERR(0, 207, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_25);
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_oy, __pyx_t_14, __pyx_t_25, __pyx_callargs+1, 0) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_ox, __pyx_t_17, __pyx_t_25, __pyx_callargs+1, 1) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_py, __pyx_t_13, __pyx_t_25, __pyx_callargs+1, 2) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_px, __pyx_t_22, __pyx_t_25, __pyx_callargs+1, 3) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_rotation, __pyx_t_23, __pyx_t_25, __pyx_callargs+1, 4) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_frame, __pyx_t_24, __pyx_t_25, __pyx_callargs+1, 5) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_shape, __pyx_v_mask, __pyx_t_25, __pyx_callargs+1, 6) < 0) __PYX_ERR(0, 207, __pyx_L1_error)
        __pyx_t_1 = __Pyx_Object_Vectorcall_CallFromBuilder(__pyx_t_16, __pyx_callargs+__pyx_t_18, (1-__pyx_t_18) | (__pyx_t_18*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_25);
      ...
      __Pyx_XDECREF_SET(__pyx_v_poly_pos, ((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_t_1));
      __pyx_t_1 = 0;

      __pyx_t_26 = __Pyx_PyList_Append(__pyx_v_collage_positions, ((PyObject *)__pyx_v_poly_pos)); if (unlikely(__pyx_t_26 == ((int)-1))) __PYX_ERR(0, 217, __pyx_L1_error)
      __pyx_L5_continue:;
    }

    __pyx_t_26 = __Pyx_PyList_Append(__pyx_v_result, __pyx_v_collage_positions); if (unlikely(__pyx_t_26 == ((int)-1))) __PYX_ERR(0, 219, __pyx_L1_error)
  }
  ...
  __Pyx_AddTraceback("polyis.pack.pack_ffd.convert_collage_array_to_python", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_result);
  __Pyx_XDECREF(__pyx_v_collage_positions);
  __PYX_XCLEAR_MEMVIEW(&__pyx_v_mask_view, 1);
  __Pyx_XDECREF(__pyx_v_mask);
  __Pyx_XDECREF((PyObject *)__pyx_v_poly_pos);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_3__pyx_unpickle_PyPolyominoPosition(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_6polyis_4pack_8pack_ffd_3__pyx_unpickle_PyPolyominoPosition = {"__pyx_unpickle_PyPolyominoPosition", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6polyis_4pack_8pack_ffd_3__pyx_unpickle_PyPolyominoPosition, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6polyis_4pack_8pack_ffd_3__pyx_unpickle_PyPolyominoPosition(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__pyx_unpickle_PyPolyominoPosition (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "__pyx_unpickle_PyPolyominoPosition", 0) < 0) __PYX_ERR(1, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("__pyx_unpickle_PyPolyominoPosition", 1, 3, 3, i); __PYX_ERR(1, 1, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 3)) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__pyx_unpickle_PyPolyominoPosition", 1, 3, 3, __pyx_nargs); __PYX_ERR(1, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("polyis.pack.pack_ffd.__pyx_unpickle_PyPolyominoPosition", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6polyis_4pack_8pack_ffd_2__pyx_unpickle_PyPolyominoPosition(__pyx_self, __pyx_v___pyx_type, __pyx_v___pyx_checksum, __pyx_v___pyx_state);
...
static PyObject *__pyx_pf_6polyis_4pack_8pack_ffd_2__pyx_unpickle_PyPolyominoPosition(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_v___pyx_PickleError = 0;
  PyObject *__pyx_v___pyx_result = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_unpickle_PyPolyominoPosition", 0);
  ...
  __pyx_t_3 = ((PyObject *)__pyx_mstate_global->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition);
  __Pyx_INCREF(__pyx_t_3);
  __pyx_t_4 = 0;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_v___pyx_type};
  ...
  if (__pyx_t_2) {
    ...
    if (!(likely(PyTuple_CheckExact(__pyx_v___pyx_state))||((__pyx_v___pyx_state) == Py_None) || __Pyx_RaiseUnexpectedTypeError("tuple", __pyx_v___pyx_state))) __PYX_ERR(1, 9, __pyx_L1_error)
    __pyx_t_1 = __pyx_f_6polyis_4pack_8pack_ffd___pyx_unpickle_PyPolyominoPosition__set_state(((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)__pyx_v___pyx_result), ((PyObject*)__pyx_v___pyx_state)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 9, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
static PyObject *__pyx_f_6polyis_4pack_8pack_ffd___pyx_unpickle_PyPolyominoPosition__set_state(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *__pyx_v___pyx_result, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_unpickle_PyPolyominoPosition__set_state", 0);
  ...
  __pyx_v___pyx_result->ox = __pyx_t_1;
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  ...
  __pyx_v___pyx_result->oy = __pyx_t_1;
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  ...
  __pyx_v___pyx_result->px = __pyx_t_1;
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  __pyx_t_1 = __Pyx_PyLong_As_int(__Pyx_PyTuple_GET_ITEM(__pyx_v___pyx_state, 4)); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L1_error)
  __pyx_v___pyx_result->py = __pyx_t_1;
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  __pyx_t_1 = __Pyx_PyLong_As_int(__Pyx_PyTuple_GET_ITEM(__pyx_v___pyx_state, 5)); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L1_error)
  __pyx_v___pyx_result->rotation = __pyx_t_1;
  if (unlikely(__pyx_v___pyx_state == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(1, 12, __pyx_L1_error)
  }
  ...
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_XDECREF(__pyx_t_7);
  __Pyx_AddTraceback("polyis.pack.pack_ffd.__pyx_unpickle_PyPolyominoPosition__set_state", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_tp_new_6polyis_4pack_8pack_ffd_PyPolyominoPosition(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *p;
  PyObject *o;
  #if CYTHON_COMPILING_IN_LIMITED_API
  ...
  #endif
  p = ((struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)o);
  p->shape = Py_None; Py_INCREF(Py_None);
  return o;
}

static void __pyx_tp_dealloc_6polyis_4pack_8pack_ffd_PyPolyominoPosition(PyObject *o) {
  struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *p = (struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)o;
  #if CYTHON_USE_TP_FINALIZE
  if (unlikely((PY_VERSION_HEX >= 0x03080000 || __Pyx_PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE)) && __Pyx_PyObject_GetSlot(o, tp_finalize, destructor)) && !__Pyx_PyObject_GC_IsFinalized(o)) {
    if (__Pyx_PyObject_GetSlot(o, tp_dealloc, destructor) == __pyx_tp_dealloc_6polyis_4pack_8pack_ffd_PyPolyominoPosition) {
...
static int __pyx_tp_traverse_6polyis_4pack_8pack_ffd_PyPolyominoPosition(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *p = (struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)o;
  {
...
static int __pyx_tp_clear_6polyis_4pack_8pack_ffd_PyPolyominoPosition(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *p = (struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition *)o;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_oy(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_oy(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2oy_3__set__(o, v);
  }
  else {
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_ox(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_ox(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2ox_3__set__(o, v);
  }
  else {
    PyErr_SetString(PyExc_NotImplementedError, "__del__");
    return -1;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_py(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_py(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2py_3__set__(o, v);
  }
  else {
    PyErr_SetString(PyExc_NotImplementedError, "__del__");
    return -1;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_px(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_px(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_2px_3__set__(o, v);
  }
  else {
    PyErr_SetString(PyExc_NotImplementedError, "__del__");
    return -1;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_rotation(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_rotation(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_8rotation_3__set__(o, v);
  }
  else {
    PyErr_SetString(PyExc_NotImplementedError, "__del__");
    return -1;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_frame(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_frame(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5frame_3__set__(o, v);
  }
  else {
    PyErr_SetString(PyExc_NotImplementedError, "__del__");
    return -1;
...
static PyObject *__pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_shape(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_1__get__(o);
}

static int __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_shape(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_3__set__(o, v);
  }
  else {
    return __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5shape_5__del__(o);
  }
}

static PyMethodDef __pyx_methods_6polyis_4pack_8pack_ffd_PyPolyominoPosition[] = {
  {"__reduce_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0},
  {"__setstate_cython__", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_6polyis_4pack_8pack_ffd_PyPolyominoPosition[] = {
  {"oy", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_oy, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_oy, 0, 0},
  {"ox", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_ox, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_ox, 0, 0},
  {"py", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_py, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_py, 0, 0},
  {"px", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_px, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_px, 0, 0},
  {"rotation", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_rotation, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_rotation, 0, 0},
  {"frame", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_frame, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_frame, 0, 0},
  {"shape", __pyx_getprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_shape, __pyx_setprop_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_shape, 0, 0},
  {0, 0, 0, 0, 0}
};
#if CYTHON_USE_TYPE_SPECS
static PyType_Slot __pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition_slots[] = {
  {Py_tp_dealloc, (void *)__pyx_tp_dealloc_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {Py_tp_repr, (void *)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_3__repr__},
  {Py_tp_doc, (void *)PyDoc_STR("Represents the position and orientation of a polyomino in a collage.")},
  {Py_tp_traverse, (void *)__pyx_tp_traverse_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {Py_tp_clear, (void *)__pyx_tp_clear_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {Py_tp_methods, (void *)__pyx_methods_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {Py_tp_getset, (void *)__pyx_getsets_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {Py_tp_init, (void *)__pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_1__init__},
  {Py_tp_new, (void *)__pyx_tp_new_6polyis_4pack_8pack_ffd_PyPolyominoPosition},
  {0, 0},
};
static PyType_Spec __pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition_spec = {
  "polyis.pack.pack_ffd.PyPolyominoPosition",
  sizeof(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition),
  0,
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE|Py_TPFLAGS_HAVE_GC,
  __pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition_slots,
};
#else

static PyTypeObject __pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition = {
  PyVarObject_HEAD_INIT(0, 0)
  "polyis.pack.pack_ffd.""PyPolyominoPosition", /*tp_name*/
  sizeof(struct __pyx_obj_6polyis_4pack_8pack_ffd_PyPolyominoPosition), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_dealloc*/
  ...
  0, /*tp_setattr*/
  0, /*tp_as_async*/
  __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_3__repr__, /*tp_repr*/
  0, /*tp_as_number*/
  0, /*tp_as_sequence*/
  0, /*tp_as_mapping*/
  0, /*tp_hash*/
  ...
  PyDoc_STR("Represents the position and orientation of a polyomino in a collage."), /*tp_doc*/
  __pyx_tp_traverse_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_traverse*/
  __pyx_tp_clear_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  ...
  0, /*tp_dictoffset*/
  #endif
  __pyx_pw_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_1__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_6polyis_4pack_8pack_ffd_PyPolyominoPosition, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "polyis.pack.pack_ffd.""array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "polyis.pack.pack_ffd.""Enum", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryview_spec = {
  "polyis.pack.pack_ffd.memoryview",
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "polyis.pack.pack_ffd.""memoryview", /*tp_name*/
...
static PyType_Spec __pyx_type___pyx_memoryviewslice_spec = {
  "polyis.pack.pack_ffd._memoryviewslice",
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "polyis.pack.pack_ffd.""_memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_type_init_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Type init code ---*/
  #if CYTHON_USE_TYPE_SPECS
  __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition = (PyTypeObject *) __Pyx_PyType_FromModuleAndSpec(__pyx_m, &__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition_spec, NULL); if (unlikely(!__pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition)) __PYX_ERR(0, 70, __pyx_L1_error)
  if (__Pyx_fix_up_extension_type_from_spec(&__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition_spec, __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  #else
  __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition = &__pyx_type_6polyis_4pack_8pack_ffd_PyPolyominoPosition;
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  #endif
  #if !CYTHON_USE_TYPE_SPECS
  if (__Pyx_PyType_Ready(__pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition->tp_dictoffset && __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition->tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition->tp_getattro = PyObject_GenericGetAttr;
  }
  #endif
  if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_PyPolyominoPosition, (PyObject *) __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject *) __pyx_mstate->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
...
static int __pyx_pymod_exec_pack_ffd(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pack_ffd},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_pack_ffd(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pack_ffd(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pack_ffd(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pack_ffd' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "pack_ffd" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_pack_ffd", 0);
  ...
  if (__pyx_module_is_main_polyis__pack__pack_ffd) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "polyis.pack.pack_ffd")) {
      if (unlikely((PyDict_SetItemString(modules, "polyis.pack.pack_ffd", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  __pyx_t_5 = __Pyx_ImportDottedModule(__pyx_mstate_global->__pyx_n_u_numpy, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_np, __pyx_t_5) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  __pyx_t_5 = __Pyx_CyFunction_New(&__pyx_mdef_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_5__reduce_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_PyPolyominoPosition___reduce_cyt, NULL, __pyx_mstate_global->__pyx_n_u_polyis_pack_pack_ffd, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition, __pyx_mstate_global->__pyx_n_u_reduce_cython, __pyx_t_5) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  __pyx_t_5 = __Pyx_CyFunction_New(&__pyx_mdef_6polyis_4pack_8pack_ffd_19PyPolyominoPosition_7__setstate_cython__, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_PyPolyominoPosition___setstate_c, NULL, __pyx_mstate_global->__pyx_n_u_polyis_pack_pack_ffd, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_6polyis_4pack_8pack_ffd_PyPolyominoPosition, __pyx_mstate_global->__pyx_n_u_setstate_cython, __pyx_t_5) < 0) __PYX_ERR(1, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  __pyx_t_5 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_kp_u_list_list_PyPolyominoPosition) < 0) __PYX_ERR(0, 89, __pyx_L1_error)
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_6polyis_4pack_8pack_ffd_1pack_all, 0, __pyx_mstate_global->__pyx_n_u_pack_all, NULL, __pyx_mstate_global->__pyx_n_u_polyis_pack_pack_ffd, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_CyFunction_SetAnnotationsDict(__pyx_t_4, __pyx_t_5);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_pack_all, __pyx_t_4) < 0) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_6polyis_4pack_8pack_ffd_3__pyx_unpickle_PyPolyominoPosition, 0, __pyx_mstate_global->__pyx_n_u_pyx_unpickle_PyPolyominoPositi, NULL, __pyx_mstate_global->__pyx_n_u_polyis_pack_pack_ffd, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[3])); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_pyx_unpickle_PyPolyominoPositi, __pyx_t_4) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init polyis.pack.pack_ffd", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init polyis.pack.pack_ffd");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_Failed_to_allocate_memory_for_po, sizeof(__pyx_k_Failed_to_allocate_memory_for_po), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_Failed_to_allocate_memory_for_po */
  ...
  {__pyx_k_PolyominoPosition_oy, sizeof(__pyx_k_PolyominoPosition_oy), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_PolyominoPosition_oy */
  {__pyx_k_PyPolyominoPosition, sizeof(__pyx_k_PyPolyominoPosition), 0, 1, 1}, /* PyObject cname: __pyx_n_u_PyPolyominoPosition */
  {__pyx_k_PyPolyominoPosition___reduce_cyt, sizeof(__pyx_k_PyPolyominoPosition___reduce_cyt), 0, 1, 1}, /* PyObject cname: __pyx_n_u_PyPolyominoPosition___reduce_cyt */
  {__pyx_k_PyPolyominoPosition___setstate_c, sizeof(__pyx_k_PyPolyominoPosition___setstate_c), 0, 1, 1}, /* PyObject cname: __pyx_n_u_PyPolyominoPosition___setstate_c */
  ...
  {__pyx_k_arrays_ptr, sizeof(__pyx_k_arrays_ptr), 0, 1, 1}, /* PyObject cname: __pyx_n_u_arrays_ptr */
  ...
  {__pyx_k_collages, sizeof(__pyx_k_collages), 0, 1, 1}, /* PyObject cname: __pyx_n_u_collages */
  ...
  {__pyx_k_frame_2, sizeof(__pyx_k_frame_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_frame_2 */
  ...
  {__pyx_k_list_list_PyPolyominoPosition, sizeof(__pyx_k_list_list_PyPolyominoPosition), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_list_list_PyPolyominoPosition */
  ...
  {__pyx_k_num_arrays, sizeof(__pyx_k_num_arrays), 0, 1, 1}, /* PyObject cname: __pyx_n_u_num_arrays */
  ...
  {__pyx_k_ox_2, sizeof(__pyx_k_ox_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_ox_2 */
  ...
  {__pyx_k_pack_all, sizeof(__pyx_k_pack_all), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pack_all */
  {__pyx_k_pack_all__returned_NULL, sizeof(__pyx_k_pack_all__returned_NULL), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_pack_all__returned_NULL */
  {__pyx_k_pickle, sizeof(__pyx_k_pickle), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pickle */
  {__pyx_k_polyis_pack_pack_ffd, sizeof(__pyx_k_polyis_pack_pack_ffd), 0, 1, 1}, /* PyObject cname: __pyx_n_u_polyis_pack_pack_ffd */
  {__pyx_k_polyis_pack_pack_ffd_pyx, sizeof(__pyx_k_polyis_pack_pack_ffd_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_polyis_pack_pack_ffd_pyx */
  {__pyx_k_polyominoes_stacks, sizeof(__pyx_k_polyominoes_stacks), 0, 1, 1}, /* PyObject cname: __pyx_n_u_polyominoes_stacks */
  {__pyx_k_pop, sizeof(__pyx_k_pop), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pop */
  {__pyx_k_px, sizeof(__pyx_k_px), 0, 1, 1}, /* PyObject cname: __pyx_n_u_px */
  {__pyx_k_px_2, sizeof(__pyx_k_px_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_px_2 */
  {__pyx_k_py, sizeof(__pyx_k_py), 0, 1, 1}, /* PyObject cname: __pyx_n_u_py */
  {__pyx_k_py_2, sizeof(__pyx_k_py_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_py_2 */
  ...
  {__pyx_k_pyx_unpickle_PyPolyominoPositi, sizeof(__pyx_k_pyx_unpickle_PyPolyominoPositi), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pyx_unpickle_PyPolyominoPositi */
  ...
  {__pyx_k_rotation_2, sizeof(__pyx_k_rotation_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_rotation_2 */
  ...
  {__pyx_k_shape_2, sizeof(__pyx_k_shape_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_shape_2 */
...
static int __Pyx_InitCachedConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  __pyx_mstate_global->__pyx_tuple[2] = PyTuple_Pack(3, __pyx_mstate_global->__pyx_int_81862720, __pyx_mstate_global->__pyx_int_69193152, __pyx_mstate_global->__pyx_int_235549177); if (unlikely(!__pyx_mstate_global->__pyx_tuple[2])) __PYX_ERR(1, 4, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  __pyx_mstate->__pyx_int_69193152 = PyLong_FromLong(69193152L); if (unlikely(!__pyx_mstate->__pyx_int_69193152)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_mstate->__pyx_int_81862720 = PyLong_FromLong(81862720L); if (unlikely(!__pyx_mstate->__pyx_int_81862720)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  __pyx_mstate->__pyx_int_235549177 = PyLong_FromLong(235549177L); if (unlikely(!__pyx_mstate->__pyx_int_235549177)) __PYX_ERR(0, 1, __pyx_L1_error)
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_stringsource, __pyx_mstate->__pyx_n_u_reduce_cython, __pyx_k_T_U_e4uD_T_DPQ_G1F_a_vWA_q_t7_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 8, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 89, 176};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_polyominoes_stacks, __pyx_mstate->__pyx_n_u_h, __pyx_mstate->__pyx_n_u_w, __pyx_mstate->__pyx_n_u_num_arrays, __pyx_mstate->__pyx_n_u_arrays_ptr, __pyx_mstate->__pyx_n_u_result, __pyx_mstate->__pyx_n_u_collages, __pyx_mstate->__pyx_n_u_i};
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_polyis_pack_pack_ffd_pyx, __pyx_mstate->__pyx_n_u_pack_all, __pyx_k_89_Qa_Q_q_6_Rq_Q_k_U_1_5_OqPQ_Y, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[3] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_stringsource, __pyx_mstate->__pyx_n_u_pyx_unpickle_PyPolyominoPositi, __pyx_k_hk_A_1_R_R_T_T_U_haq_7_5Q6LNZ_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[3])) goto bad;
  }
