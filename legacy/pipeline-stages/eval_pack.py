...
def main():
    ...
    run_benchmark(dataset_config, eval_config, metrics_config)


def run_benchmark(dataset_config: dict, eval_config: dict, metrics_config: dict):
    ...
    dconfig = {
        **dataset_config,
        ...
        "output_sub_fol": '.',
        "input_gt": './tracked_no_op.jsonl',
        "input_track": './tracked_op.jsonl',
        "skip": 1,
        'tracker': 'sort',
    }
