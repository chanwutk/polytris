...
def process_dataset_video(dataset_video_pair):
    FNS = [
    ...
    dataset, video = dataset_video_pair
    results_summary = {}
...
def benchmark_compress():
    ...
    with multiprocessing.Pool(processes=16) as pool:
        results = [*track(pool.imap_unordered(process_dataset_video, DATASET_VIDEO), total=len(DATASET_VIDEO))]
    
    results_summary = {}
    for result in results:
        results_summary = {**results_summary, **result}
