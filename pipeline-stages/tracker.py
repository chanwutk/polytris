...
def track(bboxQueue: Queue[npt.NDArray | None], trackQueue: Queue, benchmarkQueue: Queue, max_age: int = 35):
    ...
    while True:
        ...
        tracked_objects, track_benchmark = tracker.update(detections)

        trackQueue.put(tracked_objects)
