...
class ScriptRunner:
    ...
    def __init__(self, args):
        ...
        self.pipeline_stages = {
            'preprocessing': [
                ('000_preprocess_dataset.py', 'Preprocess raw video dataset'),
                ('001_preprocess_groundtruth_detection.py', 'Preprocess groundtruth detection data'),
                ('002_preprocess_groundtruth_tracking.py', 'Preprocess groundtruth tracking data'),
            ],
            'tuning': [
                ('010_tune_segment_videos.py', 'Tune video segmentation parameters'),
                ('011_tune_detect.py', 'Tune object detection parameters'),
                ('012_tune_create_training_data.py', 'Create training data for classifiers'),
                ('013_tune_train_classifier.py', 'Train and tune classifiers'),
                # ('014_tune_select_classifier.py', 'Select best classifier configuration'),
                # ('015_tune_regulate_tracking.py', 'Tune tracking regulation parameters'),
            ],
            'execution': [
                ('020_exec_classify.py', 'Execute classification on video segments'),
                ('021_exec_classify_correct.py', 'Correct classification results'),
                ('030_exec_compress.py', 'Compress relevant video segments'),
                ('040_exec_detect.py', 'Execute object detection on compressed segments'),
                ('050_exec_uncompress.py', 'Uncompress detection results'),
                ('060_exec_track.py', 'Execute object tracking'),
            ],
            'analysis': [
                ('070_results_statistics_acc.py', 'Generate tracking accuracy statistics'),
                ('080_throughput_gather.py', 'Gather throughput performance data'),
            ],
            'visualization': [
                ('003_preprocess_groundtruth_visualize.py', 'Visualize groundtruth data'),
                ('022_exec_classify_visualize.py', 'Visualize classification results'),
                ('031_exec_compress_visualize.py', 'Visualize compression results'),
                ('081_throughput_visualize.py', 'Visualize throughput analysis'),
                ('090_results_track_visualize.py', 'Visualize tracking results'),
            ]
        }
