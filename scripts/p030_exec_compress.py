...
def compress(dataset: str, videoset: str, video: str, classifier: str, tilesize: int,
    ...
    src_grid_y_starts, src_grid_y_ends, src_grid_x_starts, src_grid_x_ends = \
        precompute_grid_boundaries(src_grid_height, src_grid_width, tilesize)
    dst_grid_y_starts, dst_grid_y_ends, dst_grid_x_starts, dst_grid_x_ends = \
        precompute_grid_boundaries(dst_grid_height, dst_grid_width, tilesize)
    ...
    for collage_idx, collage in enumerate(collages):
        ...
        for gid, poly_pos in enumerate(collage, start=1):
            ...
            sy_starts, sx_starts, sy_ends, sx_ends, dy_starts, dx_starts, dy_ends, dx_ends = compute_polyomino_tile_boundaries(
                oy=oy,
                ox=ox,
                py=py,
                px=px,
                i_coords=i_coords,
                j_coords=j_coords,
                src_y_starts=src_grid_y_starts,
                src_y_ends=src_grid_y_ends,
                src_x_starts=src_grid_x_starts,
                src_x_ends=src_grid_x_ends,
                dst_y_starts=dst_grid_y_starts,
                dst_y_ends=dst_grid_y_ends,
                dst_x_starts=dst_grid_x_starts,
                dst_x_ends=dst_grid_x_ends,
            )
