...
def track(video_file: str, args, cache_dir: str, dataset: str, gpu_id: int, command_queue: Queue):
    """
...
def main(args):
    ...
    Note:
        - The script expects detection results from 001_preprocess_groundtruth_detection.py in:
          {CACHE_DIR}/{dataset}/execution/{video_file}/groundtruth/detection.jsonl
