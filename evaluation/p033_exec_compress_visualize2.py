...
(stored in 033_compressed_frames) and creates a visualization showing the
compression rate (number of compressed images) for each dataset using their
optimal parameters.
"""
...
def count_compressed_images_and_frames(dataset: str, classifier: str, tilesize: int, tilepadding: str,
    ...
    Args:
        ...
        sample_rate: Sample rate (default: 1)
        canvas_scale: Canvas scale factor (default: 1.0)
...
def get_compression_rates(datasets: List[str], verbose: bool = False) -> Dict[str, float]:
    ...
    for dataset in datasets:
        ...
        if verbose:
            ...
            print(f"  Canvas scale: {canvas_scale}")
