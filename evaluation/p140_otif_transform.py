...
def process_tracking_outputs(tracks_dir: str, output_dataset_dir: str, param_ids: list[int]):
    """
...
def process_otif_dataset(sota_dir: str, dataset: str, cache_dir: str):
    ...
    process_tracking_outputs(tracks_dir, output_dataset_dir, param_ids)
...
def process_leap_dataset(sota_dir: str, dataset: str, cache_dir: str):
    ...
    process_tracking_outputs(tracks_dir, output_dataset_dir, [0])
