...
def visualize_compared_accuracy_bar(results: pd.DataFrame, score_field: str, xlabel: str, output_path: str):
    """
    Create a comparison plot for tracking accuracy scores by video, tile size, sample rate, tilepadding, and tracker.
    
    Creates a faceted bar chart showing accuracy scores for different classifiers
    across videos, tile sizes, sample rates, tilepadding values, and trackers. Each facet shows one video-tilesize-sample_rate-tilepadding-tracker combination,
...
def visualize_tracking_accuracy(results: pd.DataFrame, output_dir: str, combined: bool = False):
    ...
    # Each plot shows classifiers ranked by performance for each video-tilesize-sample_rate-tilepadding-tracker combination
...
def main():
    ...
    3. Creates visualizations comparing accuracy across videos, classifiers, tile sizes, sample rates, tilepadding values, and trackers
